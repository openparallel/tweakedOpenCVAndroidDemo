			...
			public void onClick(View v){
				new Thread(new Runnable() {
					...
					public void run() {
						...
						report("----------------------------");
						report("binary thresh (32-bit)");
						report("----------------------------");
						zeroPointThreeMegaPixels(14);
						report("----------------------------");
						report("binary thresh inv (32-bit)");
						report("----------------------------");
						zeroPointThreeMegaPixels(15);
						report("----------------------------");
						report("trunc thresh (32-bit)");
						report("----------------------------");
						zeroPointThreeMegaPixels(16);
						report("----------------------------");
						report("to-zero thresh (32-bit)");
						report("----------------------------");
						zeroPointThreeMegaPixels(17);
						report("----------------------------");
						report("to-zero thresh inv (32-bit)");
						report("----------------------------");
						zeroPointThreeMegaPixels(18);
						report("----------------------------");
