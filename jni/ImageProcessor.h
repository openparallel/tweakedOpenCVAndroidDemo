...
extern "C" {
    ...
    jboolean
    JNICALL
    Java_com_example_tweakedopencvandroiddemo_MainActivity_applyFunhouseEffect(JNIEnv* env,
                                                                                      jobject thiz);
    
    JNIEXPORT
    jboolean
    JNICALL
    Java_com_example_tweakedopencvandroiddemo_MainActivity_applySketchbookEffect(JNIEnv* env, jobject thiz);
    
    
    JNIEXPORT
    jboolean
    JNICALL
    Java_com_example_tweakedopencvandroiddemo_MainActivity_applyNeonising(JNIEnv* env,
                                                                                               jobject thiz);
    
    JNIEXPORT
    void 
    JNICALL
    Java_com_example_tweakedopencvandroiddemo_MainActivity_setWorkingDir(JNIEnv* env, jobject thiz, jstring f);
